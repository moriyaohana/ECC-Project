...
from utils import signal_fft, normalized_correlation, inverse_fft
...
class OFDM(object):
    ...
    def symbols_to_signal(self, symbols: Union[OFDMSymbol, List[OFDMSymbol]], terminate: bool = True) -> List[float]:
